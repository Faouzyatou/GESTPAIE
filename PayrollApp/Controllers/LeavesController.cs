...
namespace PayrollApp.Controllers
{
    public class LeavesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EmployeeId,StartDate,EndDate,IsDeductible")] Leave leave)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmployeeId,StartDate,EndDate,IsDeductible")] Leave leave)
        {
            if (id != leave.Id)
            {
                return NotFound();
